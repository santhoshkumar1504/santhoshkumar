...
const AllProject = () => {
  ...
  const projectData = [
    ...
    },
    {
      "pid": 1007,
      "projectimage": lms,
      "projecttitle": "Library Management System ( Django )",
      "projectdesc": "A Django-based library management application with user authentication, book and member management, borrowing and return tracking, search functionality, and RESTful APIs.",
      "github": "https://github.com/santhoshkumar1504/library-management-system"
    },
