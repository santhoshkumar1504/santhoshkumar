...
const Skills = () => {
  ...
  return (
    <div className='skill-container'>
          <div id='skills'></div>
          <h2 className='text-center head my-2'>Skills</h2>
          <div className="row skill-row">

             <div className="col-md-12 col-lg-4 skill-col mt-4 " >
              <div className="skill-box">
                   <div className='skill-head d-flex'>
                    ...
                    <div className='ms-1 fs-5'>Frontend Technologies</div>
                    </div> 
                <div className='skill-set'>
                  <FaHtml5 className="skill-icon" style={{color:"#E34F26"}}/>
                  <DiCss3 className="skill-icon" style={{color:"#1572B6"}}/>
                  <DiJsBadge className="skill-icon" style={{color:"#d1bd24ff"}} />
             ...
             <div className="col-md-12 col-lg-3 skill-col mt-4">
              <div className="skill-box">
                 <div className='skill-head d-flex'>
                    <div className='skill-svg'>
            ...
            <div className="col-md-12 col-lg-3 skill-col mt-4">
              <div className="skill-box">
                 <div className='skill-head d-flex'>
                    ...
                    <div className='ms-1 fs-5'>Database</div>
                    </div> 
                <div className='skill-set'>
